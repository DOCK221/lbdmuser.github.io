...
def create_presentation():
    ...
    # MARGES STANDARDS POUR ALIGNEMENT PARFAIT
    MARGIN_LEFT = Inches(0.5)
    MARGIN_RIGHT = Inches(0.5)
    MARGIN_TOP = Inches(0.5)
    MARGIN_BOTTOM = Inches(0.5)
    CONTENT_WIDTH = Inches(9)  # 10 - 0.5 - 0.5
    CONTENT_HEIGHT = Inches(6.5)  # 7.5 - 0.5 - 0.5
    
    def add_title_slide(main_title, subtitle, student_info):
        """Page de garde avec alignement parfait"""
        ...
        # Cercle décoratif haut droit - ALIGNEMENT PARFAIT
        ...
        # Cercle décoratif bas gauche - ALIGNEMENT PARFAIT
        ...
        # Titre principal - CENTRÉ PARFAITEMENT
        ...
        # Sous-titre - CENTRÉ PARFAITEMENT
        ...
        # Encadré info - CENTRÉ PARFAITEMENT
        ...
        # Texte info - CENTRÉ PARFAITEMENT
    ...
    def add_content_slide(title, content_list, slide_number=None):
        """Slide de contenu avec alignement parfait au pixel près"""
        slide = prs.slides.add_slide(prs.slide_layouts[6])
        ...
        # Bande latérale gauche - ALIGNEMENT PARFAIT
        ...
        # Ligne accentuée orange - ALIGNEMENT PARFAIT
        ...
        # Numéro de slide - ALIGNEMENT PARFAIT en bas à droite
        if slide_number:
        ...
        # Fond du contenu - ALIGNEMENT PARFAIT
        ...
        # Zone de texte du contenu - ALIGNEMENT PARFAIT avec marges internes
    ...
    def add_highlight_slide(title, highlight_text, details_list):
        """Slide de mise en avant - ALIGNEMENT PARFAIT"""
        slide = prs.slides.add_slide(prs.slide_layouts[6])
        ...
        # Bande latérale - ALIGNEMENT PARFAIT
        side_bar = slide.shapes.add_shape(MSO_SHAPE.RECTANGLE, 0, 0, Inches(0.25), prs.slide_height)
        side_bar.fill.solid()
        side_bar.fill.fore_color.rgb = COLOR_PRIMARY
        side_bar.line.color.rgb = COLOR_PRIMARY
        ...
        # Ombre de l'encadré - ALIGNEMENT PARFAIT
        ...
        # Encadré principal - ALIGNEMENT PARFAIT
        ...
        # Texte dans l'encadré - CENTRÉ PARFAITEMENT
        ...
        # Zone des détails - ALIGNEMENT PARFAIT
    ...
    # Cercles décoratifs - ALIGNEMENT PARFAIT
    circle24_1 = slide24.shapes.add_shape(MSO_SHAPE.OVAL, Inches(8.5), Inches(0), Inches(1.5), Inches(1.5))
    circle24_1.fill.solid()
    circle24_1.fill.fore_color.rgb = RGBColor(0, 82, 184)
    circle24_1.line.color.rgb = RGBColor(0, 82, 184)
    
    circle24_2 = slide24.shapes.add_shape(MSO_SHAPE.OVAL, Inches(0), Inches(6), Inches(1.5), Inches(1.5))
    circle24_2.fill.solid()
    circle24_2.fill.fore_color.rgb = RGBColor(0, 82, 184)
    circle24_2.line.color.rgb = RGBColor(0, 82, 184)
    
    # Texte principal - CENTRÉ PARFAITEMENT
    main_text24 = slide24.shapes.add_textbox(Inches(1.5), Inches(2.8), Inches(7), Inches(0.9))
    ...
    # Sous-texte - CENTRÉ PARFAITEMENT
    sub_text24 = slide24.shapes.add_textbox(Inches(1.5), Inches(4.2), Inches(7), Inches(0.7))
    tf24b = sub_text24.text_frame
    tf24b.text = "Je suis à votre disposition pour vos questions"
    tf24b.vertical_anchor = MSO_ANCHOR.MIDDLE
    p24b = tf24b.paragraphs[0]
    p24b.font.size = Pt(26)
    p24b.font.color.rgb = RGBColor(255, 255, 255)
    p24b.alignment = PP_ALIGN.CENTER
    
    # Sauvegarde
    prs.save('/workspace/Soutenance_Mouhamadou_Sow_FINAL_PARFAIT.pptx')
    print("✅ Présentation FINALE PARFAITE créée !")
    print(f"📊 {len(prs.slides)} slides avec alignement professionnel au pixel près")
