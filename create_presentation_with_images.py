...
def create_presentation():
    ...
    # SLIDE 6 - AVEC IMAGE DES SERVICES
    add_content_slide_with_image(
        "Mes Missions de Community Manager",
        [
    ...
    # Sauvegarde
    prs.save('/workspace/Soutenance_Mouhamadou_Sow_AVEC_IMAGES.pptx')
    print("✅ Présentation AVEC IMAGES créée !")
    print("📸 Images intégrées sur les slides 4 et 6")
    print(f"📊 {len(prs.slides)} slides avec visuels professionnels")
