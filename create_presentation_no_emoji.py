...
def create_presentation():
    ...
    add_content_slide(
        ...
        [
            ...
            "Engagement social : Aide aux personnes sans abri (France et international)",
    ...
    add_content_slide(
        ...
        [
            ...
            "Réutilisation : Supports pour la prospection commerciale générale",
    ...
    add_content_slide(
        ...
        [
            "3 réunions entre Buroxia et l'équipe d'Ayaa.lbns",
            "Réunion 1 (visio) : Présentation de l'offre et premiers échanges",
            "Réunion 2 (visio) : Affinage de la proposition et conditions",
            "Réunion 3 (présentiel) : Visite des locaux à Marseille + finalisation",
    ...
    add_content_slide(
        ...
        [
            ...
            "Visibilité élargie sur une cible qualifiée",
    ...
    add_content_slide(
        ...
        [
            ...
            "Rigueur rédactionnelle et professionnelle",
