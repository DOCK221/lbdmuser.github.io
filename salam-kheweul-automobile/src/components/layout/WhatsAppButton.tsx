...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="group fixed bottom-5 right-5 z-40 flex h-14 w-14 items-center justify-center rounded-full border border-gold/30 bg-anthracite shadow-[0_12px_40px_rgba(0,0,0,0.45)] transition-transform duration-500 hover:scale-105 hover:border-gold"
    >
